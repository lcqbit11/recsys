...
dfoff = pd.read_csv('/Users/changqingli/pycharm_projects/algorithms/weekend_content/o2o/data/ccf_offline_stage1_train.csv')
dftest = pd.read_csv('/Users/changqingli/pycharm_projects/algorithms/weekend_content/o2o/data/ccf_offline_stage1_test_revised.csv')
dfon = pd.read_csv('/Users/changqingli/pycharm_projects/algorithms/weekend_content/o2o/data/ccf_online_stage1_train.csv')
print('data read end.')
...
print("---save model---")
with open('model_LR1.pkl', 'wb') as f:
    pickle.dump(model, f)
with open('model_LR1.pkl', 'rb') as f:
    model = pickle.load(f)
...
dftest1.to_csv('submit_LR1.csv', index=False, header=False)
dftest1.head()
