# -*- coding:utf-8 -*- 
# tensorflow 1.3
## self-define model_v2 named "deep and cross network" #
...
parser.add_argument(
    '--model_dir', type=str, default='../model_v2',
    help='Base directory for the model_v2.')
parser.add_argument(
    '--model_type', type=str, default='deep_cross',
    help="Valid model_v2 types: {'wide', 'deep', 'wide_deep', 'deep_cross'}.")
parser.add_argument(
...
parser.add_argument(
    '--batch_size', type=int, default=2, help='Number of examples per batch.')
parser.add_argument(
    '--train_data', type=str, default='../data/train_data.csv',
    help='Path to the training data.')
parser.add_argument(
    '--test_data', type=str, default='../data/test_data.csv',
...
def build_model_columns():
  ...
  workclass = tf.feature_column.categorical_column_with_vocabulary_list(
      'workclass', [
          'workclass_a', 'workclass_b', 'workclass_c'
      ])
...
def Mode_mine(features, labels, mode, params):
  ...
  # ======= define your loss for the model_v2 ======= #
  ...
  # ======= define your train_op for the model_v2 ======= #
...
def main(unused_argv):
  # Clean up the model_v2 directory if present
  shutil.rmtree(FLAGS.model_dir, ignore_errors=True)
  model = build_estimator(FLAGS.model_dir, FLAGS.model_type)

  # Train and evaluate the model_v2 every `FLAGS.epochs_per_eval` epochs.
